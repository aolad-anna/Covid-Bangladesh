...
import kotlinx.android.synthetic.main.activity_pop_up_window.progress123
import kotlinx.android.synthetic.main.activity_pop_up_window.progress1234
import kotlinx.android.synthetic.main.activity_pop_up_window2.*
...
class PopUpWindow2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progress12345.visibility=View.VISIBLE
        progress123456.visibility=View.VISIBLE

        val First_doses_data: TextView = findViewById(R.id.First_doses_data)
        val Secound_doses_data: TextView = findViewById(R.id.Secound_doses_data)

        val First_against_data: TextView = findViewById(R.id.First_against_data)
        val Secound_against_data: TextView = findViewById(R.id.Secound_against_data)
        ...
        call.enqueue(object : Callback<List<Vaccine>> {
            ...
            override fun onResponse(response: Response<List<Vaccine>>?, retrofit: Retrofit?) {
                ...
                if (response?.body() != null) {
                    ...
                    progress12345.visibility=View.GONE
                    progress123456.visibility=View.GONE
